...
?>
<?php
function cyranod6_bl_susy2_preprocess_page(&$vars){
...
// permet usage de vieilles versions de jQuery
        //drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/jquery-migrate-1.2.1.min.js', 'theme');
//chargement des plugins qui utilisent la version de jQuery par défaut du site
//   drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/responsive-nav.js','theme');
//   drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/tinynav.min.js','theme');
    //   drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/jquery.navobile.min.js','theme');
    //   drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/jquery.jpanelmenu.min.js','theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/selectnav.min.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/jquery.sticky.js', 'theme');
  //  drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/jquery.sidebar.min.js', 'theme');

//chargement des scripts qui utilisent la version de jQuery par défaut du site
    drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/js_jquery_defaut.js', 'theme');
// mise en place du noConflict pour utiliser plusieurs versions de jQuery   
    drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/jquery_init.js', 'theme');
//chargement des plugins qui utilisent une version de jQuery plus récente
    drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/jquery.flexslider.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/js/jquery.bxslider.min.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_bl_susy2') . '/3rdparty/buttons/js/buttons.js', 'theme');
...
function cyranod6_bl_susy2_webform_view_messages($node, $teaser, $page, $submission_count, $limit_exceeded, $allowed_roles, $closed, $cached) {
...
function cyranod6_bl_susy2_filefield_file($file) {
...
function cyranod6_bl_susy2_more_link ($url, $title) {
