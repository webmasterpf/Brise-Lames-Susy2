...
*/?>
<!--______________NODE TPL page_presse.tpl CUSTOM________________ -->
    ...
    <div class="node-inner">
        ...
        <div id="colonne-1" class="col1_layout_4_8 contenu-vdl">
            ...
            <?php if ($node->field_fiche_action_intervenants[0]['view'] OR 
                      $node->field_fichier_joint_presse[0]['view']): ?>
            ...
            <div class="fiche-action-vdl">
               ...
               print $node->content['field_fichier_joint']['field']['#title'] ?>
                    <ul>
               <?php
               foreach ($node->field_fichier_joint_presse as $key => $lien) {
                    print '<li>'.$node->field_fichier_joint_presse[$key]['view'].'</li>';
               }
               ?>  
                  </ul>   </div>
            <?php endif;?>
