...
*/?>
<!--______________NODE TPL page_sortie_actions.tpl CUSTOM________________ -->
        ...
        <div id="colonne-1" class="col1_layout_4_8 contenu-vdl">
            ...
            <div class="fiche-action-vdl">
               ...
               print $node->content['field_fichier_joint']['field']['#title'] ?>
                    <ul>
               <?php
               foreach ($node->field_fichier_joint_innovation as $key => $lien) {
                    print '<li>'.$node->field_fichier_joint_innovation[$key]['view'].'</li>';
               }
               ?>  
                  </ul>   </div>
            <?php endif;?>
